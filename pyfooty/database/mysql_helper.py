...
from database.schemas import TeamTable, TeamInstanceTable, CompetitionTable, SeasonTable, VenueTable, FixtureTable
...
with database.session() as session:
    ...
    prem = CompetitionTable(name='premier_league', competition_type='domestic', competition_format='league', team_type='local')
